...
import 'package:yaho_project/allConstants/app_constants.dart';
import 'package:yaho_project/allWidgets/loading_view.dart';
import 'package:yaho_project/model/chatUser.dart';
import 'package:yaho_project/providers/profile_provider.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void updateFirestoreData() {
    ...
    setState(() {
      isLoading = true;
      if (dialCodeDigits != "+221" && _phoneController.text != "") {
    ...
    profileProvider.updateFirestoreData(
      ...
      Fluttertoast.showToast(msg: 'Mise a jour avec succes');
    }).catchError((onError) {
      Fluttertoast.showToast(msg: onError.toString());
    });
  }
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          vertical15,
                          const Text('A propos de vous...', style: TextStyle(
                            fontStyle: FontStyle.italic,
                            fontWeight: FontWeight.bold,
                            color: AppColors.spaceCadet
                          ),),
                          TextField(
                            decoration: kTextInputDecoration.copyWith(
                                hintText: 'Ecrire a propos de vous...'),
                            onChanged: (value) {
                              aboutMe = value;
                            },
                          ),
                          vertical15,
                          const Text('Selectionner un code pays', style: TextStyle(
                            fontStyle: FontStyle.italic,
                            fontWeight: FontWeight.bold,
                            color: AppColors.spaceCadet,
                          ),),
